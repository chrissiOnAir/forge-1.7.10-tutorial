...
import com.chrissionair.tutorial.world.GenLayerBiomeTutorial;

import cpw.mods.fml.common.eventhandler.SubscribeEvent;

public class Tutorial_Biome_Event {

	// private static WorldType wType;
	
	// Forge WorldTypeEvent used in WorldChunkManager.class
	@SubscribeEvent
	public void onBiomeInit(InitBiomeGens e) {
		
		// this.wType = e.worldType;
		e.newBiomeGens = initializeAllBiomeGeneratorsTutorial(e.seed, e.worldType);
	}
	
	// copied from GenLayer.class
	public static GenLayer[] initializeAllBiomeGeneratorsTutorial(long par0, WorldType par2WorldType)
    {
        boolean flag = false;
        ...
        // BOF getBiomeLayer Tutorial
        GenLayer ret = new GenLayerBiomeTutorial(200L, genlayer3, par2WorldType);
        ret = GenLayerZoom.magnify(1000L, ret, 2);
        Object object = new GenLayerBiomeEdge(1000L, ret);
        
        // Object object = par2WorldType.getBiomeLayerTutorial(par0, genlayer3);
        // EOF 
	...
	// copied from WorldType.class
	/*
    public GenLayer getBiomeLayerTutorial(long worldSeed, GenLayer parentLayer)
    {
        GenLayer ret = new GenLayerBiomeTutorial(200L, parentLayer, this.wType);
        ret = GenLayerZoom.magnify(1000L, ret, 2);

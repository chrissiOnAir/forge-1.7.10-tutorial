...
public class WorldGenMegaJungle_Tut extends WorldGenHugeTrees_Tut
{
    private static final String __OBFID = "CL_00000420";

    public WorldGenMegaJungle_Tut(boolean p_i45456_1_, int p_i45456_2_, int p_i45456_3_, int p_i45456_4_, int p_i45456_5_)
    {
    ...
    {
    	// relative maxHeight from extended Height Range
        ...
        else
        {
            ...
            // logs für die Seitenkronen
            for (int i1 = par4 + l - 2 - par2Random.nextInt(4); i1 > par4 + l / 2; i1 -= 2 + par2Random.nextInt(4))
            {
            	// diese Methode gibt scheinbar lineare zufällige Richtung an, aus einem kreis
                ...
                for (l1 = 0; l1 < 5; ++l1)
                {
                	// die Kreisrichtung stufenweise (nach Blockgrösse?) gesetzt
                ...
                l1 = 1 + par2Random.nextInt(2);// Höhenspanne der Seitenkrone
                int i2 = i1;

                for (int j2 = i1 - l1; j2 <= i2; ++j2)
                {
                    int k2 = j2 - i2;// relative Höhe ist auch relative Kronenspanne
                    // Seitenkronen
            ...
            for (int l2 = 0; l2 < l; ++l2)
            {
                ...
                if (block.isAir(par1World, par3, par4 + l2, par5) || block.isLeaves(par1World, par3, par4 + l2, par5))
                {
                    ...
                    // die Vines rundherum; vines haben nach Richtungen metadaten 1,2,4,8
                    if (l2 > 0)
                    {
                ...
                // und die anderen 3 Stämme, um 1 kleiner
                if (l2 < l - 1)
                {
    ...
    // Top Krone
    // tss .. hier Wert_4 die Höhe, Wert_5 wie üblich die Spanne
    ...
    {
        byte b0 = 2;// Kronenhöhe relativ

        for (int i1 = p_150543_4_ - b0; i1 <= p_150543_4_; ++i1)
        {
            int j1 = i1 - p_150543_4_;// Spanne aus relativer Höhe

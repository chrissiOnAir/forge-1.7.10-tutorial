...
public class WorldGenTaiga2_Tut extends WorldGenAbstractTree
{
    private static final String __OBFID = "CL_00000435";

    public WorldGenTaiga2_Tut(boolean par1)
    {
        super(par1);
    }
    ...
    {
        int l = par2Random.nextInt(4) + 6;// Höhe
        int i1 = 1 + par2Random.nextInt(2);// unterer Stamm
        int j1 = l - i1;// oberer Stamm
        int k1 = 2 + par2Random.nextInt(2);// Spanne Krone
        boolean flag = true;
        ...
        if (par4 >= 1 && par4 + l + 1 <= 256)
        {
            ...
            else
            {
                ...
                if (isSoil && par4 < 256 - l - 1)
                {
                    ...
                    l3 = par2Random.nextInt(2);// neue Spanne
                    i2 = 1;
                    byte b0 = 0;
                    int k2;
                    int i4;
                    ...
                    // Krone
                    for (i4 = 0; i4 <= j1; ++i4)// remember: j1 ist oberer Bereich ;) amy ..
                    {
                        k2 = par4 + l - i4;// von oben nach unten
                        ...
                        if (l3 >= i2)// nicht leicht nachvollziehbar ;)
                        {
                            l3 = b0;
                            b0 = 1;
                            ++i2;

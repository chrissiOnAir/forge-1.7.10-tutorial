...
public class TutorialGrass extends Block implements IGrowable
{
    ...
    public void updateTick(World p_149674_1_, int p_149674_2_, int p_149674_3_, int p_149674_4_, Random p_149674_5_)
    {
        if (!p_149674_1_.isRemote)
        {
            ...
            {
                p_149674_1_.setBlock(p_149674_2_, p_149674_3_, p_149674_4_, Tutorial.tutorialDirt);
            }
            else if (p_149674_1_.getBlockLightValue(p_149674_2_, p_149674_3_ + 1, p_149674_4_) >= 9)
            {
                for (int l = 0; l < 4; ++l)
                {
                    ...
                    if (p_149674_1_.getBlock(i1, j1, k1) == Tutorial.tutorialDirt && p_149674_1_.getBlockMetadata(i1, j1, k1) == 0 && p_149674_1_.getBlockLightValue(i1, j1 + 1, k1) >= 4 && p_149674_1_.getBlockLightOpacity(i1, j1 + 1, k1) <= 2)
                    {
                        p_149674_1_.setBlock(i1, j1, k1, Tutorial.tutorialGrass);
                    }
                }
            }
        }
    ...
    {
        return Tutorial.tutorialDirt.getItemDropped(0, p_149650_2_, p_149650_3_);
    }
        ...
        while (l < 128)
        {
            ...
            while (true)
            {
                if (l1 < l / 16)
                {
                    ...
                    if (p_149853_1_.getBlock(i1, j1 - 1, k1) == Tutorial.tutorialGrass && !p_149853_1_.getBlock(i1, j1, k1).isNormalCube())
                    {
                        ++l1;
                        continue;
                    }
